...
import Role_to_userAttributesPage from './components/role_to_userAttributesPage/Role_to_userAttributesPage'
import Role_to_userAssociationsPage from './components/role_to_userAssociationsPage/Role_to_userAssociationsPage'
import Role_to_userTabsA from './components/Role_to_userTabsA'
import Role_to_userConfirmationDialog from './components/Role_to_userConfirmationDialog'
...
export default function Role_to_userCreatePanel(props) {
  ...
  function getInitialValueOkStates() {
    ...
    initialValueOkStates.push({ key: 'userId', valueOk:0 });
    initialValueOkStates.push({ key: 'roleId', valueOk:0 });
  ...
  function doSave(event) {
    ...
    */
    api.role_to_user.createItem(graphqlServerUrl, values.current)
      .then(response => {
        //Check response
        if (
          response.data &&
    ...
    <Dialog fullScreen open={open} onClose={handleCancel} TransitionComponent={Transition}>
      <AppBar className={classes.appBar}>
        <Toolbar>
          ...
          <Tooltip title={"Save role_to_user"}>
            <Fab 
              color="secondary" 
      ...
      <div className={classes.root}>
        ...
        {/* Confirmation Dialog */}
        <Role_to_userConfirmationDialog
...
Role_to_userCreatePanel.propTypes = {
