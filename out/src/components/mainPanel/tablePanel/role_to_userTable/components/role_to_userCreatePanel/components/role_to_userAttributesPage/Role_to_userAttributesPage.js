...
import Role_to_userAttributesFormView from './role_to_userAttributesFormView/Role_to_userAttributesFormView'
...
export default function Role_to_userAttributesPage(props) {
      ...
      <Fade in={!hidden} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12} sm={10} md={9} lg={8} xl={7}>
            <Role_to_userAttributesFormView
...
Role_to_userAttributesPage.propTypes = {
