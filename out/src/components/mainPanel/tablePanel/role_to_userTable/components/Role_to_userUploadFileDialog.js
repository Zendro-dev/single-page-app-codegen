...
export default function Role_to_userUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddRole_to_userCsv{ id } }'
...
Role_to_userUploadFileDialog.propTypes = {
