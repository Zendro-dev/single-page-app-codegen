...
export default function Transcript_countEnhancedTableToolbar(props) {
                      ...
                      <Grid container>
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            <Grid item>
                              <Tooltip title="Add new transcript_count">
                                <IconButton
                                  color="primary"
                            ...
                            <Grid item>
                              <form action={exportServerUrl}>
                                <input type="hidden" name="model" value='transcript_count' />
...
Transcript_countEnhancedTableToolbar.propTypes = {
