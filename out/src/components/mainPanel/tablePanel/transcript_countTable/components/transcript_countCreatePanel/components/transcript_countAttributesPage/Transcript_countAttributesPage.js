...
import Transcript_countAttributesFormView from './transcript_countAttributesFormView/Transcript_countAttributesFormView'
...
export default function Transcript_countAttributesPage(props) {
      ...
      <Fade in={!hidden} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12} sm={10} md={9} lg={8} xl={7}>
            <Transcript_countAttributesFormView
...
Transcript_countAttributesPage.propTypes = {
