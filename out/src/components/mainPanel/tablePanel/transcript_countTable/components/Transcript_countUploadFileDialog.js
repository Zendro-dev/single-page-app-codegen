...
export default function Transcript_countUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddTranscript_countCsv{ id } }'
...
Transcript_countUploadFileDialog.propTypes = {
