...
export default function AminoacidsequenceEnhancedTableToolbar(props) {
                      ...
                      <Grid container>
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            <Grid item>
                              <Tooltip title="Add new aminoacidsequence">
                                <IconButton
                                  color="primary"
                            ...
                            <Grid item>
                              <form action={exportServerUrl}>
                                <input type="hidden" name="model" value='aminoacidsequence' />
...
AminoacidsequenceEnhancedTableToolbar.propTypes = {
