...
export default function AminoacidsequenceUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddAminoacidsequenceCsv{ id } }'
...
AminoacidsequenceUploadFileDialog.propTypes = {
