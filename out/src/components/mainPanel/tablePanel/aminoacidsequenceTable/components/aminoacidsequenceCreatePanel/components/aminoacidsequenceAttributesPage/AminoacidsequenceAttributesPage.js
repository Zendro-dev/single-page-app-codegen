...
import AminoacidsequenceAttributesFormView from './aminoacidsequenceAttributesFormView/AminoacidsequenceAttributesFormView'
...
export default function AminoacidsequenceAttributesPage(props) {
      ...
      <Fade in={!hidden} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12} sm={10} md={9} lg={8} xl={7}>
            <AminoacidsequenceAttributesFormView
...
AminoacidsequenceAttributesPage.propTypes = {
