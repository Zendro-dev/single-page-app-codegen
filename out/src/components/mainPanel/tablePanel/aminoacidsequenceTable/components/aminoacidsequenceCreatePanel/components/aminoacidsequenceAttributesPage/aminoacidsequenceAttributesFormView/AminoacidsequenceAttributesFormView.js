...
export default function AminoacidsequenceAttributesFormView(props) {
        ...
        <Grid item xs={12}>
          <Card className={classes.card}>
            ...
            */}
            ...
            {/* Accession */}
            <CardContent key='accession' className={classes.cardContent} >
              <StringField
                itemKey='accession'
                name='accession'
                label='Accession'
                valueOk={getValueOkStatus('accession')}
                autoFocus={true}
            ...
            {/* Sequence */}
            <CardContent key='sequence' className={classes.cardContent} >
              <StringField
                itemKey='sequence'
                name='sequence'
                label='Sequence'
                valueOk={getValueOkStatus('sequence')}
                handleBlur={handleBlur}
                handleReady={handleFieldReady}
                handleChange={handleChange}
                handleKeyDown={handleKeyDown}
...
AminoacidsequenceAttributesFormView.propTypes = {
