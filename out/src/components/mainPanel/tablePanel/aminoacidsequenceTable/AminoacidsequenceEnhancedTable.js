...
import AminoacidsequenceEnhancedTableHead from './components/AminoacidsequenceEnhancedTableHead'
import AminoacidsequenceEnhancedTableToolbar from './components/AminoacidsequenceEnhancedTableToolbar'
import AminoacidsequenceCreatePanel from './components/aminoacidsequenceCreatePanel/AminoacidsequenceCreatePanel'
import AminoacidsequenceUpdatePanel from './components/aminoacidsequenceUpdatePanel/AminoacidsequenceUpdatePanel'
import AminoacidsequenceDetailPanel from './components/aminoacidsequenceDetailPanel/AminoacidsequenceDetailPanel'
import AminoacidsequenceDeleteConfirmationDialog from './components/AminoacidsequenceDeleteConfirmationDialog'
import AminoacidsequenceUploadFileDialog from './components/AminoacidsequenceUploadFileDialog'
...
export default function AminoacidsequenceEnhancedTable() {
  ...
  function getData() {
      ...
      */
      api.aminoacidsequence.getCountItems(graphqlServerUrl, search)
        .then(response => {
          if(
            response.data &&
            response.data.data
          ) {
            var newCount = response.data.data.countAminoacidsequences;
            ...
            */
            ...
            /*
              API Request: items
            */
            api.aminoacidsequence.getItems(
              graphqlServerUrl,
              search,
              orderBy,
              order,
              ...
              .then(response => {
                if (
                  response.data &&
                  response.data.data &&
                  response.data.data.aminoacidsequences) {

                  /**
                    * Debug
                    */
                  console.log("@@newCount: ", newCount);
                  console.log("@@newItems: ", response.data.data.aminoacidsequences);

                  //set new data
                  setIsOnApiRequest(false);
                  setCount(newCount);
                  setItems(response.data.data.aminoacidsequences);
                  return;
  ...
  function doDelete(event, item) {
    ...
    */
    api.aminoacidsequence.deleteItem(graphqlServerUrl, item.id)
      .then(response => {
        if(
          response.data &&
          response.data.data
  ...
  return (
    <div className={classes.root}>
      <Grid container justify='center'>
        <Grid item xs={12} md={11} lg={10}>
          <Paper className={classes.paper}>
            ...
            {/* Toolbar */}
            <AminoacidsequenceEnhancedTableToolbar
              search={search}
            ...
            <div className={classes.tableWrapper}>
              <Table stickyHeader size='medium'>
                ...
                {/* Table Head */}
                <AminoacidsequenceEnhancedTableHead
                  order={order}
                  orderBy={orderBy}
                  rowCount={count}
      ...
      {(deleteConfirmationDialogOpen) && (
        <AminoacidsequenceDeleteConfirmationDialog
      ...
      {(uploadFileDialogOpen) && (
        <AminoacidsequenceUploadFileDialog
