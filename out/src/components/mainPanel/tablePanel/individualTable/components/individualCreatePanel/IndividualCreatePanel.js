...
import IndividualAttributesPage from './components/individualAttributesPage/IndividualAttributesPage'
import IndividualAssociationsPage from './components/individualAssociationsPage/IndividualAssociationsPage'
...
export default function IndividualCreatePanel(props) {
  ...
  function doSave(event) {
    ...
    */
    api.individual.createItem(graphqlServerUrl, values.current)
      .then(response => {
        //Check response
        if (
          response.data &&
