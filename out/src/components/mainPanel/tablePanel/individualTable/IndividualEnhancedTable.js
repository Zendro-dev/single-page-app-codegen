...
import IndividualCreatePanel from './components/individualCreatePanel/IndividualCreatePanel'
import IndividualUpdatePanel from './components/individualUpdatePanel/IndividualUpdatePanel'
import IndividualDetailPanel from './components/individualDetailPanel/IndividualDetailPanel'
...
export default function IndividualEnhancedTable() {
  ...
  function getData() {
      ...
      */
      api.individual.getCountItems(graphqlServerUrl, search)
        .then(response => {
          if(
            response.data &&
            response.data.data
          ) {
            var newCount = response.data.data.countIndividuals;
            ...
            api.individual.getItems(
              ...
              .then(response => {
                if (
                  response.data &&
                  response.data.data &&
                  response.data.data.individuals) {

                  /**
                    * Debug
                    */
                  console.log("@@newCount: ", newCount);
                  console.log("@@newItems: ", response.data.data.individuals);

                  //set new data
                  setIsOnApiRequest(false);
                  setCount(newCount);
                  setItems(response.data.data.individuals);
                  return;
  ...
  function doDelete(event, item) {
    ...
    */
    api.individual.deleteItem(graphqlServerUrl, item.id)
      .then(response => {
        if(
          response.data &&
          response.data.data
