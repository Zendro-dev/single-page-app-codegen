...
import RoleCreatePanel from './components/roleCreatePanel/RoleCreatePanel'
import RoleUpdatePanel from './components/roleUpdatePanel/RoleUpdatePanel'
import RoleDetailPanel from './components/roleDetailPanel/RoleDetailPanel'
import RoleDeleteConfirmationDialog from './components/RoleDeleteConfirmationDialog'
...
export default function RoleEnhancedTable() {
  ...
  function getData() {
      ...
      */
      api.role.getCountItems(graphqlServerUrl, search)
        .then(response => {
          if(
            response.data &&
            response.data.data
  ...
  function doDelete(event, item) {
    ...
    */
    api.role.deleteItem(graphqlServerUrl, item.id)
      .then(response => {
        if(
          response.data &&
          response.data.data
