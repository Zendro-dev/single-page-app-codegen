...
export default function SequencingExperimentEnhancedTableToolbar(props) {
                      ...
                      <Grid container>
                        <Grid item xs={12}>
                          <Grid container justify="center">
                            <Grid item>
                              <Tooltip title="Add new sequencingExperiment">
                                <IconButton
                                  color="primary"
                            ...
                            <Grid item>
                              <form action={exportServerUrl}>
                                <input type="hidden" name="model" value='sequencingExperiment' />
...
SequencingExperimentEnhancedTableToolbar.propTypes = {
