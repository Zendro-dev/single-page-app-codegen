...
import SequencingExperimentAttributesPage from './components/sequencingExperimentAttributesPage/SequencingExperimentAttributesPage'
import SequencingExperimentAssociationsPage from './components/sequencingExperimentAssociationsPage/SequencingExperimentAssociationsPage'
import SequencingExperimentTabsA from './components/SequencingExperimentTabsA'
import SequencingExperimentConfirmationDialog from './components/SequencingExperimentConfirmationDialog'
...
export default function SequencingExperimentCreatePanel(props) {
  ...
  function getInitialValueOkStates() {
    ...
    initialValueOkStates.push({ key: 'start_date', valueOk:0 });
    initialValueOkStates.push({ key: 'end_date', valueOk:0 });
    initialValueOkStates.push({ key: 'description', valueOk:0 });
    initialValueOkStates.push({ key: 'float', valueOk:0 });
    initialValueOkStates.push({ key: 'date_time', valueOk:0 });
    initialValueOkStates.push({ key: 'time', valueOk:0 });
    initialValueOkStates.push({ key: 'i', valueOk:0 });
    initialValueOkStates.push({ key: 'bool', valueOk:0 });
  ...
  function doSave(event) {
    ...
    */
    api.sequencingExperiment.createItem(graphqlServerUrl, values.current)
      .then(response => {
        //Check response
        if (
          response.data &&
      ...
      <AppBar className={classes.appBar}>
        <Toolbar>
          ...
          <Typography variant="h6" className={classes.title}>
            {'New SequencingExperiment'}
          </Typography>
          <Tooltip title={"Save sequencingExperiment"}>
            <Fab 
              color="secondary" 
...
SequencingExperimentCreatePanel.propTypes = {
