...
import SequencingExperimentAttributesFormView from './sequencingExperimentAttributesFormView/SequencingExperimentAttributesFormView'
...
export default function SequencingExperimentAttributesPage(props) {
      ...
      <Fade in={!hidden} timeout={500}>
        ...
        > 
          ...
          <Grid item xs={12} sm={10} md={9} lg={8} xl={7}>
            <SequencingExperimentAttributesFormView
...
SequencingExperimentAttributesPage.propTypes = {
