...
export default function SequencingExperimentUploadFileDialog(props) {
  ...
  const handleSubmit = (event) => {
    if(file.current !== undefined && file.current !== null) {
      ...
      let query = 'mutation{ bulkAddSequencingExperimentCsv{ id } }'
  ...
  return (
    ...
    >
      <DialogTitle>
        Uploading SequencingExperiments
      </DialogTitle>
...
SequencingExperimentUploadFileDialog.propTypes = {
