...
import SequencingExperimentEnhancedTableHead from './components/SequencingExperimentEnhancedTableHead'
import SequencingExperimentEnhancedTableToolbar from './components/SequencingExperimentEnhancedTableToolbar'
import SequencingExperimentCreatePanel from './components/sequencingExperimentCreatePanel/SequencingExperimentCreatePanel'
import SequencingExperimentUpdatePanel from './components/sequencingExperimentUpdatePanel/SequencingExperimentUpdatePanel'
import SequencingExperimentDetailPanel from './components/sequencingExperimentDetailPanel/SequencingExperimentDetailPanel'
import SequencingExperimentDeleteConfirmationDialog from './components/SequencingExperimentDeleteConfirmationDialog'
import SequencingExperimentUploadFileDialog from './components/SequencingExperimentUploadFileDialog'
...
export default function SequencingExperimentEnhancedTable() {
  ...
  function getData() {
      ...
      */
      api.sequencingExperiment.getCountItems(graphqlServerUrl, search)
        .then(response => {
          if(
            response.data &&
            response.data.data
          ) {
            var newCount = response.data.data.countSequencingExperiments;
            ...
            */
            ...
            /*
              API Request: items
            */
            api.sequencingExperiment.getItems(
              graphqlServerUrl,
              search,
              orderBy,
              order,
              ...
              .then(response => {
                if (
                  response.data &&
                  response.data.data &&
                  response.data.data.sequencingExperiments) {

                  /**
                    * Debug
                    */
                  console.log("@@newCount: ", newCount);
                  console.log("@@newItems: ", response.data.data.sequencingExperiments);

                  //set new data
                  setIsOnApiRequest(false);
                  setCount(newCount);
                  setItems(response.data.data.sequencingExperiments);
                  return;
  ...
  function doDelete(event, item) {
    ...
    */
    api.sequencingExperiment.deleteItem(graphqlServerUrl, item.id)
      .then(response => {
        if(
          response.data &&
          response.data.data
